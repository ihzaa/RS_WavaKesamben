...
{
    //Fungsi tampil index list agenda ada di searchpostcontroller

    public function detail($id)
    {
        $data = [];
        $data['content'] = AgendaActivity::find($id);
        ...
        return view('user.healthyPromotion.agendaActivity.detail', compact('data'));
    }
}

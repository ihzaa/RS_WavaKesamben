                        ...
                        <table cellspacing="0">
                            <tr>
                                <td>
                                    <table class="soapbox">
                                        <tr>
                                            <td class="soapbox-title">Selamat Datang di {{ env('APP_NAME') }}!</td>
                                        </tr>
                                    </table>
                                    ...
                                    <table class="body">
                                        <tr>
                                            ...
                                            <td class="body-padded">
                                                <div class="body-title">Halo {{ $data['name'] }}, terima kasih telah
                                                    mendaftar
                                                </div>
                                                <table class="body-text">
                                                    <tr>
                                                        <td class="body-text-cell">
                                                            Kami telah menyetuji data pendaftaran baru anda. Silakan
                                                            gunakan
                                                            nomer kartu diatas untuk melakukan pendaftaran klinik
                                                            selanjutnya.
                                                        </td>
                                                    </tr>
                                                </table>

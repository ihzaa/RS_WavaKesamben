...
@section('page_title', 'Tambah Informasi Kesehatan')

@section('breadcrumb')
    <li class="breadcrumb-item active">Promosi Kesehatan</li>
    <li class="breadcrumb-item active"><a href="{{ route('admin.healthyPromotion.healthyInfo.index') }}">Informasi
            Kesehatan</a></li>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Tambah Informasi Kesehatan</h3>
                            <!-- /.card-tools -->
                        </div>
                        <!-- /.card-header -->
                        <form enctype="multipart/form-data"
                            action="{{ route('admin.healthyPromotion.healthyInfo.add.post') }}" method="POST"
                            id="main_form">
                            <div class="card-body">
                                @if ($errors->any())
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-4">
                                        <img id="blah" class="img-fluid" alt="your image"
                                            src="{{ asset('images/default/picture.svg') }}" />
                                    </div>
                            ...
                            <div class="card-footer d-flex">
                                <a class="btn btn-warning text-light"
                                    href="{{ route('admin.healthyPromotion.healthyInfo.index') }}"><i

...
@section('page_title', 'Edit Informasi Kesehatan')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Edit Informasi Kesehatan</h3>
                            <!-- /.card-tools -->
                        </div>
                        <!-- /.card-header -->
                        <form enctype="multipart/form-data"
                            action="{{ route('admin.healthyPromotion.healthyInfo.edit.post', [$data['item']->id]) }}"

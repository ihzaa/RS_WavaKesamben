...
@section('page_title', 'Tambah Agenda Kegiatan')

@section('breadcrumb')
    <li class="breadcrumb-item active">Promosi Kesehatan</li>
    <li class="breadcrumb-item active"><a href="{{ route('admin.healthyPromotion.agendaActivity.index') }}">Agenda
            Kegiatan</a></li>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <form enctype="multipart/form-data"
                            action="{{ route('admin.healthyPromotion.agendaActivity.add.post') }}" method="POST"
                            id="main_form">
                            <div class="card-body">
                                @if ($errors->any())

                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <h3 class="card-title">List Agenda Kegiatan</h3>
                            <div class="card-tools">
                                <a class="btn btn-primary btn-sm"
                                    href="{{ route('admin.healthyPromotion.agendaActivity.add') }}"><i
                                        class="fas fa-plus"></i>
                                    Tambah</a>
                            </div>
                        </div>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a class="btn btn-sm btn-success ml-1 mr-1" data-toggle="tooltip"
                                                        ...
                                                        href="{{ route('admin.healthyPromotion.agendaActivity.edit', [$item->id]) }}">

                                        ...
                                        <tr>
                                            <td class="body-padding mobile-padding">
                                                ...
                                                <table cellpadding="0" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td
                                                            style="text-align:center; font-size:30px; padding-bottom:20px;">Maaf,
                                                            Pendaftaran anda telah kami tolak!
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="padding-bottom:20px;">
                                                            ...
                                                            <br>
                                                            Pendaftaran anda melalui website kami tolak dengan detail
                                                            sebagai berikut :<br>
                                                            <br>
